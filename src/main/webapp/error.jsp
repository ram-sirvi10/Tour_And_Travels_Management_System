...
<style>
    ...
    .circle:nth-child(1) { width: 200px; height: 200px; left: 10%; top: 20%; }
    .circle:nth-child(2) { width: 300px; height: 300px; left: 70%; top: 10%; }
    .circle:nth-child(3) { width: 150px; height: 150px; left: 50%; top: 70%; }
