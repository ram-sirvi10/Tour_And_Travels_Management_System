...
<div class="dashboard-container">
    ...
    <div class="main-content">
        ...
        <table class="table table-bordered table-striped mt-3">
            ...
            <tbody>
            <%
            int serial = 1; // Serial number counter
            ...
            %>
                <tr>
                    ...
                    <td>
                        <a class="action-link" href="<%=request.getContextPath()%>/admin?button=userAction&userId=<%=user.getUserId()%>&action=<%=user.isActive() ? "deactivate" : "activate"%>">
                            <%=user.isActive() ? "Deactivate" : "Activate"%>
                        </a>
                        <a class="action-link text-danger" href="<%=request.getContextPath()%>/admin?button=userAction&userId=<%=user.getUserId()%>&action=delete" onclick="return confirm('Are you sure you want to permanently delete this user?');">
                            Delete
                        </a>
                    </td>
                </tr>
