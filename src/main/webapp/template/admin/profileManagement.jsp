			...
			<div class="card profile-card p-5 shadow-lg"
				...
				<div class="d-flex flex-column align-items-center">
					...
					<div class="d-flex gap-3">
						<a
							href="<%=request.getContextPath()%>/template/admin/profileManagement.jsp?button=updateProfile"
							class="btn btn-outline-primary btn-lg">Edit Profile</a> <a
							href="<%=request.getContextPath()%>/template/admin/profileManagement.jsp?button=changePassword"
				...
				<form method="post" action="<%=request.getContextPath()%>/admin"
					...
					<div class="mb-3">
						<label class="form-label">Name</label> <input type="text"
							...
							value="<%=formData != null ? formData.getUsername() : user.getUserName()%>">
						<%
					...
					<div class="mb-3">
						<label class="form-label">Email</label> <input type="email"
							...
							value="<%=formData != null ? formData.getEmail() : user.getUserEmail()%>">
						<%
					...
					<div class="d-flex justify-content-between">
						...
						<a href="<%=request.getContextPath()%>/admin?button=dashboard"
