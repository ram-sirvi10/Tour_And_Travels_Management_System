...
.card.agencies { background: linear-gradient(135deg, #43e97b, #38f9d7); }
.card.pending { background: linear-gradient(135deg, #f7971e, #ffd200); }
.card.rejected { background: linear-gradient(135deg, #f5576c, #f093fb); }
...
<div class="row g-4">
    <div class="col-md-6 col-sm-12">
        <a href="<%=request.getContextPath()%>/admin?button=manageUsers" class="card-link">
    ...
    <div class="col-md-6 col-sm-12">
        <a href="<%=request.getContextPath()%>/admin?button=manageAgencies" class="card-link">
    ...
    <div class="col-md-6 col-sm-12">
        <a href="<%=request.getContextPath()%>/admin?button=pendingAgencies" class="card-link">
    ...
    <div class="col-md-6 col-sm-12">
        <a href="<%=request.getContextPath()%>/admin?button=deletedAgencies" class="card-link">
