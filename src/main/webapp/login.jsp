...
<body>
	...
	<div class="toast-container">
		<div
			class="toast show align-items-center text-bg-danger border-0 .fade-alert"
...
%>
	...
	<div class="login-card">
		...
		<form action="./auth" method="post">
			...
			<input type="hidden" name="button" value="login"> <input
		...
		<div class="mt-3 text-center">
			...
			%>
			<p>
				Don't have an agency account? <a href="registerAgency.jsp">Register
					Here</a>
			</p>
			<%
			} else {
			%>
			<p>
				Don't have an account? <a href="registerUser.jsp">Register Here</a>
			</p>
			<%
			}
			%>
